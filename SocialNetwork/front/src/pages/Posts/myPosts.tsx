                            ...
                            <div className="relative">
                                ...
                                <div className="absolute right-3 top-3 flex gap-2">
                                    <button
                                        ...
                                        className="inline-flex items-center gap-2 rounded-full bg-black/40 p-2 text-white hover:bg-red-600"
                                    >
                                        Delete
                                    </button>
                                </div>
                            ...
                            <div className="p-4">
                                ...
                                <div className="mt-4 flex items-center justify-between">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <Link to={`/posts/${post.id}`} className="text-xs text-violet-400 hover:underline">View</Link>
                                    </div>
                                </div>
